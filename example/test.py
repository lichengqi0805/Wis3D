...
pcd_path = np.load('/media/nio/Storage/20211225T095742_8N3824__1640397696.000000__1640397726.000000/PANDAR128/1640397697.272055.npz')['data']
wis3d.add_point_cloud(pcd_path[:, :3], name="pcd0")
# Add boxes
...
# wis3d.add_boxes(box_position, box_euler, axes=box_scale)
